...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<portfolio-big-input-action></portfolio-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<portfolio-big-input-action [disabled]="true"></portfolio-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<portfolio-big-input-action fontSet="fas" fontIcon="fa-trash"></portfolio-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<portfolio-big-input-action label="delete"></portfolio-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<portfolio-big-input-action (action)="actionHandler()"></portfolio-big-input-action>`;
    fixture = createHostComponent(template);
